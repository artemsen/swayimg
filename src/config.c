...
static const struct configdef_kv def_keysv[] = {
    ...
    { "k",                "zoom keep"                                },
    { "Alt+s",            "zoom"                                     },
    { "Alt+period",       "position center"                          },
    { "Alt+h",            "position left"                            },
    { "Alt+j",            "position bottom"                          },
    { "Alt+k",            "position top"                             },
    { "Alt+l",            "position right"                           },
    { "Alt+y",            "position top_left"                        },
    { "Alt+u",            "position top_right"                       },
    { "Alt+b",            "position bottom_left"                     },
    { "Alt+n",            "position bottom_right"                    },
    { "Alt+p",            "position"                                 },
