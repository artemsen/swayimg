...
public:
    ...
    void activate(ImagePtr image) override;
    void deactivate() override;
    void reset() override;
    ImagePtr current_image() override;
...
public:
    ...
    argb_t bkg_window = { argb_t::min, 0, 0, 0 }; ///< Window background
...
private:
    ...
    ssize_t img_x = 0, img_y = 0; ///< Image position on canvas
