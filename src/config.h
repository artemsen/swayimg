...
#define CFG_VIEW_AA_ON     "antialiasing"
#define CFG_VIEW_AA_START  "antialiasing_start"
...
#define CFG_GLRY_AA_ON     "antialiasing"
#define CFG_GLRY_AA_START  "antialiasing_start"
