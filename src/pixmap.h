...
// ISO C++ (used in the tests) doesn't like this kind of initialization; it
// isn't used in the tests anyway, so just don't include it there
#ifndef __cplusplus
// The array is declared static but in a header file since it's used in multiple
// places (at least gallery.c and viewer.c); declare it possibly unused to avoid
// warnings from every other file that imports pixmap.h
// clang-format off
static const char* pixmap_scale_names[] __attribute__ ((unused)) = {
