...
TEST_F(ImageList, Add)
{
    ...
    ASSERT_EQ(imglist_first(), img[0]);
    ASSERT_EQ(imglist_last(), img[2]);
}
...
TEST_F(ImageList, Duplicate)
{
    ...
    ASSERT_STREQ(imglist_first()->source, "exec://1");
    ASSERT_STREQ(imglist_last()->source, "exec://2");
}
...
TEST_F(ImageList, Find)
{
    ...
    ASSERT_TRUE(img);
    ASSERT_STREQ(img->source, "exec://1");

    ASSERT_TRUE(imglist_find("exec://2"));
    ASSERT_FALSE(imglist_find("not_exist"));
}
...
TEST_F(ImageList, Replace)
{
    imglist_init(config);
    imglist_add("exec://1");

    struct image* img = image_create("exec://1");
    ASSERT_TRUE(imglist_replace(img));
    ASSERT_EQ(imglist_find("exec://1"), img);
}
...
TEST_F(ImageList, Next)
{
    ...
    ASSERT_EQ(imglist_next(img1), img2);
    ASSERT_EQ(imglist_next(img2), nullptr);
}
...
TEST_F(ImageList, Prev)
{
    ...
    ASSERT_EQ(imglist_prev(img2), img1);
    ASSERT_EQ(imglist_prev(img1), nullptr);
}
...
TEST_F(ImageList, NextFile)
{
    ...
    ASSERT_EQ(imglist_next_file(img1), img2);
    ASSERT_EQ(imglist_next_file(img2), img3);
    ASSERT_EQ(imglist_next_file(img3), nullptr);
}
...
TEST_F(ImageList, NextFileLoop)
{
    ...
    ASSERT_EQ(imglist_next_file(img1), img2);
    ASSERT_EQ(imglist_next_file(img2), img3);
    ASSERT_EQ(imglist_next_file(img3), img1);
}
...
TEST_F(ImageList, PrevFile)
{
    ...
    ASSERT_EQ(imglist_prev_file(img1), nullptr);
    ASSERT_EQ(imglist_prev_file(img3), img2);
    ASSERT_EQ(imglist_prev_file(img2), img1);
}
...
TEST_F(ImageList, PrevFileLoop)
{
    ...
    ASSERT_EQ(imglist_prev_file(img1), img3);
    ASSERT_EQ(imglist_prev_file(img3), img2);
    ASSERT_EQ(imglist_prev_file(img2), img1);
}
...
TEST_F(ImageList, NextDir)
{
    ...
    ASSERT_EQ(imglist_next_dir(img11), img23);
    ASSERT_EQ(imglist_next_dir(img12), img23);
    ASSERT_EQ(imglist_next_dir(img23), nullptr);
    ASSERT_EQ(imglist_next_dir(img24), nullptr);
}
...
TEST_F(ImageList, NextDirLoop)
{
    ...
    ASSERT_EQ(imglist_next_dir(img11), img23);
    ASSERT_EQ(imglist_next_dir(img12), img23);
    ASSERT_EQ(imglist_next_dir(img23), img11);
    ASSERT_EQ(imglist_next_dir(img24), img11);
}
...
TEST_F(ImageList, PrevDir)
{
    ...
    ASSERT_EQ(imglist_prev_dir(img11), nullptr);
    ASSERT_EQ(imglist_prev_dir(img12), nullptr);
    ASSERT_EQ(imglist_prev_dir(img23), img12);
    ASSERT_EQ(imglist_prev_dir(img24), img12);
}
...
TEST_F(ImageList, PrevDirLoop)
{
    ...
    ASSERT_EQ(imglist_prev_dir(img11), img24);
    ASSERT_EQ(imglist_prev_dir(img12), img24);
    ASSERT_EQ(imglist_prev_dir(img23), img12);
    ASSERT_EQ(imglist_prev_dir(img24), img12);
}
...
TEST_F(ImageList, Forward)
{
    ...
    ASSERT_EQ(imglist_fwd(img1, 0), img1);
    ASSERT_EQ(imglist_fwd(img1, 1), img2);
    ASSERT_EQ(imglist_fwd(img1, 2), img3);
    ASSERT_EQ(imglist_fwd(img1, 1000), img4);
    ASSERT_EQ(imglist_fwd(img4, 1000), img4);
}
...
TEST_F(ImageList, Backward)
{
    ...
    ASSERT_EQ(imglist_back(img4, 0), img4);
    ASSERT_EQ(imglist_back(img4, 1), img3);
    ASSERT_EQ(imglist_back(img4, 2), img2);
    ASSERT_EQ(imglist_back(img4, 1000), img1);
}
